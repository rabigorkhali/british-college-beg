<header class="main-header" style="background-color: #fff;">
    ...
    <a href="{{ route('frontend.index') }}" class="logo" style="background-color: #fff;height: 88px;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini">
             <img height="" width="" class="navbar-brand" src="{{url('img/TWC_mini.png')}}"
              style="height: 46px; padding-right: 2px; padding-left: 2px; padding-top: 3px; padding-bottom: 0px; 
        ...
        <span class="logo-lg">
           {{--  @php
            ...
            @if($settings->logo)
              ...
              <img height="48" width="226" class="navbar-brand" src="{{url('../img/TWC Logo Color.png')}}">
            @else --}}
                <!-- {{ app_name() }} -->
              <!--  The Woolwich College -->
              <img height="" width="" class="navbar-brand" src="{{url('img/TWC Logo Color.png')}}" 
              style="width: 160px; height: 90px; padding-bottom: 15px; border-bottom-width: 0px;">
           {{--  @endif --}}
        </span>
    </a>

    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #1f3860;height: 60px;">
